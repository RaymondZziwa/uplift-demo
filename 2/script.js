...
const check = () =>{
    if( document.getElementById("imgqtn").src.indexOf("imgs/1.png")!=-1 && data == "math"){
        document.getElementById("status").style.visibility="visible";
        setTimeout(change,1500)
       // document.getElementById("imgqtn").src="imgs/2.png";
       // document.getElementById("status").style.visibility="hidden";
    }else if ( document.getElementById("imgqtn").src.indexOf("imgs/2.png")!=-1 && data == "bios"){
        document.getElementById("status").style.visibility="visible";
        setTimeout(change2,1500)
    }else if(document.getElementById("imgqtn").src.indexOf("imgs/3.png")!=-1 && data == "physics"){
        document.getElementById("status").style.visibility="visible";
...
const change2 = ()=>{
    document.getElementById("status").style.visibility="hidden";
    document.getElementById("imgqtn").src="imgs/3.png";
}
